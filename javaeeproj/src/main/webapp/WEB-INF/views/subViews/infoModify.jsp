...
<div id="infoModify" class="index hide">
    <%
        String encodedUserList = request.getParameter("userList");
//        out.print(encodedUserList);
    %>
    <form class="form-horizontal" action="infoModify?userList=${encodedUserList}" method="post" onsubmit="return checkInfo();">
        ...
        <div class="info-modify col-md-4 col-sm-12 col-xs-12">
            ...
            <div class="hide">
                <input id="avatarValue" type="text" name="avatarImg" value="${user.avatar.avatarimg}">
            </div>
