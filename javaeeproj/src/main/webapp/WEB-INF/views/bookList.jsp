        ...
        <div class="categories col-md-2 col-sm-6 col-xs-12">
            <ul class="nav nav-pills nav-stacked">
                <c:forEach items="${smallTypesOfBook}" var="smallType">
                    <li><a href="bookList?bookType=${bookType}&smallType=${smallType.smalltypename}">${smallType.smalltypename}</a></li>
                </c:forEach>
            </ul>
        </div>
                ...
                <div class="panel-body">
                    ...
                    <c:forEach items="${books}" var="book">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="thumbnail">
                                <img src="getBookCover?coverPath=${book.bookcover}" alt="${book.booktitle}">
                                <div class="caption">
                                    <div class="bookTitle text-center text-success" title="${book.booktitle}">${book.booktitle}</div>
                                    <div class="btn-block text-center">
                                        <a href="book_download?bookID=${book.id}&filePath=${book.bookfile}" class="btn btn-link">下载</a>
