                ...
                <div class="panel-body">
                    ...
                    <div class="book-labels col-md-5 clearfix">
                        <p>
                            ...
                            <label class="label-value">${book.booktitle}</label>
                        </p>
                        <p>
                            <label class="label-name">作者：</label>
                            <label class="label-value">${book.bookauthor}</label>
                        </p>
                        <p>
                            <label class="label-name">出版时间：</label>
                            <label class="label-value">${book.bookpubyear}</label>
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            <label class="label-value">
                                <a href="bookdownload?bookID=${book.id}&filePath=${book.bookfile}" class="btn btn-sm btn-info">
                                    ${format}&nbsp;<i class="glyphicon glyphicon-download-alt"></i></a>
                            </label>
                        </p>
                        <p>
                            <label class="label-name">简介：</label>
                            <label class="label-value">${book.booksummary}</label>
                        </p>
                    </div>
