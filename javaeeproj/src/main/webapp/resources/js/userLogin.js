$(document).ready(function () {
    ...
    function n(o) {
        $(".uploadBtn button").tooltip("destroy"), console.log("登录成功！" + o.user.userCode + "," + o.user.userName + "," + o.user.contributionValue), $("#loginHead").addClass("hide"), $("#userHead").removeClass("hide"), e(o), $avatar = $("#navbar #loginedInfo a img"), $avatar.attr("src", o.user.avatar.avatarimg), $avatar.attr("alt", o.user.avatar.avatartxt)
    }
